function varargout = histogram(img, varargin)
%HISTOGRAM  Histogram of 2D/3D grayscale or color images
%
%   Usage 
%   H = histogram(IMG);
%   histogram(IMG);
...
%     kymorod.core.image.histogram(img);
%
...
%     kymorod.core.image.histogram(X, X>0, 0:88)
%
%   See also
%     imhist, hist, histcounts

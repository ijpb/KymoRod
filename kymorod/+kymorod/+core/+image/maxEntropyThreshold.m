function [value, maxEntropy] = maxEntropyThreshold(img, varargin)
%MAXENTROPYTHRESHOLD Compute image threshold using maximisation of entropies.
%
%   VALUE = maxEntropyThreshold(IMG)
...
%
%   [VALUE, ENTROPY] = maxEntropyThreshold(IMG)
...
histo = kymorod.core.image.histogram(img, varargin{:})';
